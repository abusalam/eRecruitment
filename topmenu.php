<div class="MenuBar">
  <ul>
    ...
    <li
      ...
      <a href="<?php echo GetAbsoluteURLFolder(); ?>AppForm.php">Application Form</a>
    </li>
    <li
      class="<?php echo ($_SERVER['SCRIPT_NAME'] == BaseDIR . 'PrintChallan.php') ? 'SelMenuitems' : 'Menuitems'; ?>">
      <a href="<?php echo GetAbsoluteURLFolder(); ?>PrintChallan.php">Print Challan</a>
    </li>
    <li
      class="<?php echo ($_SERVER['SCRIPT_NAME'] == BaseDIR . 'AdmitCard.php') ? 'SelMenuitems' : 'Menuitems'; ?>">
      <a href="<?php echo GetAbsoluteURLFolder(); ?>AdmitCard.php">Download Admit</a>
    </li>
    <li
      class="<?php echo ($_SERVER['SCRIPT_NAME'] == BaseDIR . 'AppStatus.php') ? 'SelMenuitems' : 'Menuitems'; ?>">
      <a href="<?php echo GetAbsoluteURLFolder(); ?>AppStatus.php">Application Status</a>
    </li>
    <li
