...
<body>
  ...
  <div class="content">
    ...
    //UniqueRandAlpha();
    $Data = new DB();
    $Qry = "Select R.ResID,PostName,PostGroup,PayScale,Category,Fees,Vacancies,count(*) as Total From " . MySQL_Pre . "Posts P," . MySQL_Pre . "Categories C," . MySQL_Pre . "Reserved R," . MySQL_Pre . "Applications A"
